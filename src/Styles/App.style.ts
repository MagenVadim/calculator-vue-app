...
export const Button = styled(Flex)<Props>`
    ...
    background-color: ${(props)=> props.bg ? props.bg : "var(--key-background-orange)"};
    color: ${(props)=> (props.color ? props.color : "var(--very-dark-grayish-blue)")};
    box-shadow: 0 3px 0 ${(props)=> (props.bdbox ? props.bdbox : "var(--key-shadow-orange)")};
